...
% process image
averageImage = imresize(averageImage, [768, 1024]);
if ndims(averageImage) == 3 && size(averageImage, 3) == 3
    averageImage = rgb2gray(averageImage);
end

% Write the new version
tifFileName = fullfile(imageFolder,'average_image.tif');
imwrite(averageImage, tifFileName, 'tif');
