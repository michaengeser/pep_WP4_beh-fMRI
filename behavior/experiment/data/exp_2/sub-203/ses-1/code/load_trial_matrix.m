function [tr_mat, file_list] = load_trial_matrix(sub_num, n, exp_num)
...
if exist(file_name,'file')
    ...
    disp('loading existing trial matrix')

    % get file list
    [~, file_list] = createTrialMatrices(sub_num, n, exp_num);

else
    % make trial matrix
    [tr_mat, file_list] = createTrialMatrices(sub_num, n, exp_num);

     disp('creating new trial matrix')
end
