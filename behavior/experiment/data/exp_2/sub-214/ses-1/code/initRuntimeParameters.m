...
global F_Key J_Key CATE1_KEY CATE2_KEY RightKey LeftKey 
% text
...
SHOW_INSTRUCTIONS = 1; % 0 to skip the intruction
SHOW_PRACTICE = 1; % 0 to skip the practice run
...
FRAME_ANTICIPATION = 0.4; % optimizes timing in PTB
...
viewDistance = 55; % Default viewing distance (if no viewDist argument sent with the function call)
