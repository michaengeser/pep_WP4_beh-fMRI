...
global DEBUG ScreenHeight stimSizeHeight ScreenWidth refRate screenScaler fontSize fontColor text gray_color w REF_RATE_OPTIMAL center
...
while ~KeyIsDown
    ...
    showMessage('Press space for keyboard check');
