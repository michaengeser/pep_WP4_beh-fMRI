    ...
    for category = cfg.categories
        ...
        for analysis_name = cfg.analysis_names
            ...
            if strcmp(analysis_name, 'typical')
                filename = fullfile(pwd, '..', 'drawings', ['gem_2-5_descriptions_', category, '_MPNet_cosine']);
            elseif strcmp(analysis_name, 'control')
                filename = fullfile(pwd, '..', 'drawings', ['gem_2-5_descriptions_', category, '_control_MPNet_cosine']);
